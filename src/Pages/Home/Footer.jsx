    ...
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          ...
          <li>
              <a
                href="https://www.linkedin.com/in/avi46601/"
            ...
            <li>
              <a
                href="https://www.instagram.com/_abhi_v__/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="mailto:adi46601@gmail.com"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by ABHISHEK</p>
      </div>
    </footer>
  );
}
